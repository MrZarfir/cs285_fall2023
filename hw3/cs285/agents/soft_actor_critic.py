...
class SoftActorCritic(nn.Module):
    ...
    def update_critic(
        ...
        with torch.no_grad():
            ...
            if self.use_entropy_bonus and self.backup_entropy:
                # DONE TODO(student): Add entropy bonus to the target values for SAC
    ...
    def entropy(self, action_distribution: torch.distributions.Distribution):
        ...
        approximate_acts = action_distribution.rsample().squeeze(-1)
    ...
    def update(
        ...
        for ith_update in range(self.num_critic_updates):
